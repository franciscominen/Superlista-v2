...
import useCreateNewProduct from "~/lib/hooks/useCreateNewProduct";
...
const CreateProductModal = () => {
  ...
  const { onCreateNewProduct } = useCreateNewProduct(
    createdProduct,
    closeModal
  );
        ...
        <ModalContainer exit={exit}>
          ...
          <Form>
            ...
            <NoteInput
              ...
              onChange={(e) =>
                setCreatedProduct({ ...createdProduct, nota: e.target.value })
              }
  ...
  return (
    <>
      <EmptyListButton onClick={onOpenModal}>Crear Producto</EmptyListButton>
